...
<xsl:template match="/pokedex">
    <xsl:apply-templates select="pokemon[type='fire' or type='water' or type='flying' or type='ground' or type[2]='fire' or type[2]='water' or type[2]='flying' or type[2]='ground']" />
</xsl:template>
...
<!--
<xsl:template match="/pokedex">
  <xsl:variable name="pokemonResults" select="pokemon[type='fire' or type='water' or type='flying' or type='ground' or type[2]='fire' or type[2]='water' or type[2]='flying' or type[2]='ground']" />
...
<xsl:template match="pokemon">
    <tr>
      <td><xsl:value-of select="pokemon[type='fire' or type='water' or type='flying' or type='ground']" />(<xsl:value-of select="pokemon[type='fire' or type='water' or type='flying' or type='ground']" />)</td>
